...
+----------------------------------+--------------------------+
| Number of subcarriers            | :math:`M=16`             |
+----------------------------------+--------------------------+
| Number of activated subcarriers  | :math:`K=8`              |
+----------------------------------+--------------------------+
| Number of activation patterns    | :math:`Q=16`             |
+----------------------------------+--------------------------+
| Constellation size               | :math:`L=1`              |
+----------------------------------+--------------------------+
| Transmission rate                | :math:`R=0.25` [bps/Hz]  |
+----------------------------------+--------------------------+

Reproducible Code
=================

.. literalinclude:: ../../../imtoolkit/examples/CoherentOFDM-IdealRayleigh-BER-diversity.py
   :language: python
